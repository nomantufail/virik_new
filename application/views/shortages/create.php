                        ...
                        <table class="table table-bordered table-hover table-striped" border="1" style="font-size: 11px;">
                            ...
                            foreach($trips as $trip){
                                ...
                                <tr>
                                    ...
                                    <td><input name="<?= "quantity_".$counter ?>" id="<?= "quantity_".$counter ?>" type="number"class="form-control" step="any" onchange="shortage_changed(<?= $counter ?>)" onkeyup="shortage_changed(<?= $counter ?>)" ></td>
