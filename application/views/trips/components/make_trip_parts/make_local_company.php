        ...
        <td>
            <table class="table" style="margin-top: 15px; width: 100%;">
                <tr style="border-bottom: 1px solid lightgray;">
                    <td colspan="3" style="width: ;"><b id="count_test">Route</b><br>
                        <select name="route_<?= $row_counter ?>" onchange="i_think_route_changed('3',0,<?= $row_counter?>)" class="route route_select" style="width: 100%;">
                            <?php
                            foreach($secondary_routes as $route){
                                ?>
