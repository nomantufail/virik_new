    ...
    <div class="loginBox center-block" style="width: 400px; height: 300px; background-color: ; color: ">
        ...
        <div class="panel-body">
            ...
            <div class="list-group">
                ...
                <form class="form-horizontal" role="form" action="<?= base_url()."reports/freight_report/generate/" ?>" target="_blank" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control select_box" style="" required="required" id="products" name="trip_master_type" >
