...
<script>
    ...
    function total_cost(row_num)
    {
        ...
        var costPerItem = document.getElementById("salePricePerItem_"+row_num).value;
            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" style="margin: 10px;">
                        <section style="font-size: 20px; font-weight: normal; color: red;">Total Price: <span id="grand_total_cost_label">0</span> Rs.</section>
                    </div>
                    <div style="text-align: center">
                        <button name="save_cash_sale" class="btn btn-success" style="font-size: 20px;"><i class="fa fa-save" style="color: white;"></i> Save Invoice</button>
                    </div>
