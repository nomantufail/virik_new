            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="row" style="padding-top: 30px;">
                        ...
                        <div class="col-md-4" style="margin: 0px;">
                             <strong style="font-size: 20px;">Received: </strong><input style="height: 30px;" type="number" step="any" id="received" name="received"  onchange="grand_total_or_received_changed()" onkeyup="grand_total_or_received_changed()">
                        </div>
                        <div class="col-md-4" style="margin: 0px;">
