        ...
        <div id="voucher_area">
            ...
            <div class="row" style="">
                ...
                <div class="col-md-12 center-block">
                    ...
                    <!--Hidden fields-->
                    <input type="hidden" name="trip_detail_id" value="" id="black_oil_shortage_trip_detail_id" required="required">
                    <input type="hidden" name="trip_id" value="" id="black_oil_shortage_trip_id" required="required">
                    <input type="hidden" name="shortage_product" id="black_oil_shortage_product">
                    <input type="hidden" name="destination_voucher" id="black_oil_destination_voucher" value="0">
                    <!--*********************************************-->
